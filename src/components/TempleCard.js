...
const TempleCard = ({obj}) => {
  return (
    <motion.div  whileHover={{scale:1.1}}  transition={{duration:0.3}} className='flex flex-col border-2 border-black rounded-md  h-64  bg-black hover:shadow-md hover:shadow-gray-100 hover:cursor-pointer'>
